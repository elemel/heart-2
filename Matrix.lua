...
function Matrix:toTransposedMatrix()
    return {
        {self.a, self.d},
        {self.b, seld.e},
        {self.c, self.f},
...
function Matrix:toTransposedMatrix3()
    return {
        {self.a, self.d, 0},
        {self.b, seld.e, 0},
        {self.c, self.f, 1},
...
function Matrix:toTransposedMatrix4()
    return {
        {self.a, self.d, 0, 0},
        {self.b, self.e, 0, 0},
        {0, 0, 1, 0},
